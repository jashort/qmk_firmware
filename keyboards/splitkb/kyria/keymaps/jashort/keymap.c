 ...
 * |      |      |      |      |      | = +  |                              | PGUP | HOME |  UP  | END  |      | = +  |
 * |------+------+------+------+------+------|                              |------+------+------+------+------+------|
 * |      | LGUI | LALT | LCTL | LSFT | - _  |                              | PGDN | LEFT | DOWN | RGHT |      |  +   |
 * |------+------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------+------|
 * |      |  [   |  ]   |  {   |  }   |  _   |      | SCRL |  |      |      |      |      |      |      |      | PSCR |
 * `------+------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------+------'
 *                      |      |      |      |      |      |  |      |      |      |      |      |
 ...
 */
    [_NAV] = LAYOUT(
      _______, _______, _______, _______, _______, KC_EQL ,                                     KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______, KC_EQL,
      _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_MINS,                                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_PLUS,
      _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_UNDS, _______, KC_SCRL, _______, _______, _______, _______, _______, _______, _______, KC_PSCR,
