 ...
 * |------+------+------+------+------+------|                              |------+------+------+------+------+------|
 * |GUI_ES|  A   |  S   |  D   |  F   |  G   |                              |  H   |  J   |  K   |  L   | ; :  |MSE_QU|
 * |------+------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------+------|
 ...
 */
    [_NAV] = LAYOUT(
      ...
      _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, _______, _______, KC_SCRL, _______, _______,KC_PAUSE, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_PSCR,
 ...
 */
    [_SYM] = LAYOUT(
     ...
     KC_LBRC , KC_RBRC, KC_LCBR, KC_RCBR, KC_MINS, KC_EQL, _______, _______, _______, _______, KC_PLUS, KC_UNDS, KC_COMM,  KC_DOT, KC_SLSH, KC_QUES,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
