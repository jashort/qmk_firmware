 ...
 * |      |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      |      | LCmd | SPACE | /LOWER /       \SHIFT \  |ENTER |RAISE |      |      |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
     */
 ...
 * |      |   [  |  ]   |   {  |  }   | - _  |-------|    |-------|   _  | = +  |   +  |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      |      | LCmd | SPACE | / BKSP /       \SHIFT \  |ENTER |RAISE |      |      |
 *            |      |      |      |      |/       /         \      \ |LOWER |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
     */
 ...
 *            `----------------------------------'           '------''---------------------------'
    ...
    [NAV] = LAYOUT(
        ...
        XXXXXXX,  SPACE_L, SPACE_R, BACK,    FWD,     KC_MPLY, _______,    _______,    XXXXXXX, KC_PGDN, KC_PGUP, SW_LANG, KC_ENT, XXXXXXX,
        XXXXXXX,  XXXXXXX,  _______, _______, _______,    _______,  _______, _______, XXXXXXX, XXXXXXX
        ),
